...
(function (ColorSplitter) {
    ...
    })(Colors = ColorSplitter.Colors || (ColorSplitter.Colors = {}));
...
(function (ColorSplitter) {
    ...
    })(ImageProcessing = ColorSplitter.ImageProcessing || (ColorSplitter.ImageProcessing = {}));
})(ColorSplitter || (ColorSplitter = {}));
...
(function (ColorSplitter) {
    ...
    (function (TableView) {
        function colorToHex(color) {
            return color.map(function (component) { return ("0" + component.toString(16)).slice(-2).toLocaleUpperCase(); }).join("");
        }
        ...
        function buildRow(color) {
            ...
            if (rawRgbaColor[3] == 1) {
                colorName = ColorSplitter.Colors.getColorName(hexCode.substring(0, hexCode.length - 2));
            }
            return "<tr>" + "<td class='colorSample' style='background-color: " + rgbaToCss(rawRgbaColor) + "'></td>" + "<td>" + rawRgbaColor.join(",") + "</td>" + "<td>" + hexCode + "</td>" + "<td>" + colorName + "</td>" + "</tr>";
        }
    ...
    })(TableView = ColorSplitter.TableView || (ColorSplitter.TableView = {}));
})(ColorSplitter || (ColorSplitter = {}));
...
(function (ColorSplitter) {
    ...
    (function (Controller) {
        ...
        function showCurrentPage() {
            ...
            ColorSplitter.TableView.showTable(colorTable, colors, from, to);
